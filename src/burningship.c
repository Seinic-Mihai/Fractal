...
/*   Updated: 2016/04/13 17:01:54 by mseinic          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <fractol.h>

static void				burn_iter(t_fract *fract, size_t maxiter)
{
	t_cmplx	tmp;
...
static void				create_burn(t_env *env)
{
	t_fract		fract;
